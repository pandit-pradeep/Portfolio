        ...
        <>
            <nav className={` relative fixed top-0 left-0 w-full flex items-center justify-between px-6 py-4 z-50 transition-transform duration-300 ${visible ? "translate-y-0" : "-translate-y-full"} `}>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <div className="text-2xl font-bold text-white hidden sm:block ">Pradeep</div>
                </div>


                <div className="block lg:absolute lg:left-1/2 lg:transform lg:translate-x-1/2">
                    <button onClick={() => setMenuOpen(true)} className="text-white text-2xl focus:outline-none" aria-label="open Menu">
                        <TfiMenu />
                    </button>
                </div>
