...
import Photo from "../assets/pradeep.jpeg"
...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto md:ml-40 md:mr-30 px-6 md:px-10 lg:px-12 py-20   flex flex-col gap-12">
        ...
        >
          ...
          <motion.div className="relative w-[100px] h-[100px] md:w-[120px] md:h-[120px]
