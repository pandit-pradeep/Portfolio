...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_75%,rgba(16,185,129,0.30),transparent_70%)] "/>
      ...
      >
        ...
        <p className=" text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Pradeep Pandit. All rights reserved.
        </p>
